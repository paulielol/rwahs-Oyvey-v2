...
public class EntityUtil
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            ...
            output.put(healthSB + " " + (OyVey.friendManager.isFriend(player) ? "\u00a7b" : "\u00a7r") + player.getName() + " " + distanceSB + " " + "\u00a7f" + OyVey.totemPopManager.getTotemPopString(player) + OyVey.potionManager.getTextRadarPotion(player), (int) EntityUtil.mc.player.getDistance(player));
    ...
    public static java.util.List<BlockPos> getSphere(BlockPos loc, float r, float h, boolean hollow, boolean sphere, int plusY) {
