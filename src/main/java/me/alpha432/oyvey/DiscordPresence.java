...
public class DiscordPresence {
    ...
    public static void start() {
        ...
        DiscordPresence.rpc.Discord_Initialize("870611631237922817", handlers, true, "");
        DiscordPresence.presence.startTimestamp = System.currentTimeMillis() / 1000L;
        DiscordPresence.presence.details = ((Minecraft.getMinecraft().currentScreen instanceof GuiMainMenu) ? "In the main menu." : ("Playing " + ((Minecraft.getMinecraft().getCurrentServerData() != null) ? (RPC.INSTANCE.showIP.getValue() ? ("on " + Minecraft.getMinecraft().getCurrentServerData().serverIP + ".") : "Balling in the Neighborhood") : "Playing Career")));
        ...
        DiscordPresence.presence.partyMax = 5;
            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                if (Minecraft.getMinecraft().getCurrentServerData() != null) {
                    if (RPC.INSTANCE.showIP.getValue()) {
                        ...
                        string = "Ballin in the Neighborhood";
                    }
                } else {
                    string = "Playing Career";
                }
